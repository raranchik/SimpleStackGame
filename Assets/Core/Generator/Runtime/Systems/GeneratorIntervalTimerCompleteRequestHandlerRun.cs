...
#endif
    public class GeneratorIntervalTimerCompleteRequestHandlerRun<TSelfRequest> : IEcsRunSystem
        where TSelfRequest : struct
    {
        private readonly ILogger m_Logger;
        private readonly EcsWorld m_World;
        private readonly EcsFilter m_TimerFilter;
        private readonly EcsPool<TSelfRequest> m_RequestPool;
        ...
        public GeneratorIntervalTimerCompleteRequestHandlerRun(ILogger logger, EcsWorld world, EcsFilter timerFilter)
        {
            ...
            m_RequestPool = m_World.GetPool<TSelfRequest>();
            m_RequestFilter = m_World.Filter<TSelfRequest>().End();
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (var timer in m_TimerFilter)
            {
                ...
                m_RequestPool.Add(sourceEntity);
