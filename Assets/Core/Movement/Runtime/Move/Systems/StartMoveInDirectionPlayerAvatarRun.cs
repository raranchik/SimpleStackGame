...
#endif
    public class StartMoveInDirectionPlayerAvatarRun : IEcsRunSystem
    {
        ...
        private readonly EcsFilterInject<Inc<IsStartMoveInDirectionRequest>> m_MoveInDirFilter;
        ...
        private void MoveEntity(in int entity)
        {
            ...
            ref var animator = ref m_MoveObjectRequestFilter.Pools.Inc4.Get(entity);
            foreach (var requestEntity in m_MoveInDirFilter.Value)
            {
                ...
                animator.Value.SetBool(IsMove, true);
        ...
        private void CreateMoveRequest(in int target)
        {
            ...
            ref var moveRequest = ref m_MoveRequestPool.Value.Add(moveRequestEntity);
