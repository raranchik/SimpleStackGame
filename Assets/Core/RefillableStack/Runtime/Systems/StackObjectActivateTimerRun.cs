...
#endif
    public class StackObjectActivateTimerRun : IEcsRunSystem
    {
        private readonly EcsFilterInject<
            Inc<RefillableStackIntervalTimerTag, SourceComponent, ActivateSelfRequest>
        > m_TimerFilter;
        ...
        public StackObjectActivateTimerRun(ILogger logger)
        {
            m_Logger = logger.WithPrefix(nameof(StackObjectActivateTimerRun));
        }
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (var timerEntity in m_TimerFilter.Value)
            {
                ...
                m_IsDisabledPool.Value.Del(timerEntity);
